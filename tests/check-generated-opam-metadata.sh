...
assert_not_contains '{with-test}' nats-client.opam
assert_not_contains '"@runtest"' nats-client.opam
...
assert_not_contains '{with-test}' nats-client-async.opam
assert_not_contains '"@runtest"' nats-client-async.opam
