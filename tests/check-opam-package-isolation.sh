...
SWITCH_NAME=${NATS_ML_PACKAGE_CHECK_SWITCH:-${PACKAGE}-package-check}
OCAML_COMPILER=${NATS_ML_PACKAGE_CHECK_COMPILER:-ocaml-base-compiler.4.14.3}
DUNE_PACKAGE=${NATS_ML_PACKAGE_CHECK_DUNE:-dune.3.19.0}
